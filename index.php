...
<body>
    ...
    <section class="about section" id="about">
        <div class="container flex-center">
            <h1 class="section-title-01">About</h1>
            <h2 class="section-title-02">About</h2>
            <div class="content flex-center">
                ...
                <div class="about-info">
                    <div class="description">
                        <h3>I'm Usama</h3>
                        <h4>A lead <span>QA Engineer</span> based in <span>Pakistan</span></h4>
                        <p>Being a QA engineer, I do have experience in preparing test plans, writing test Cases. While thinking of different types of testing, I have explored many things such as Smoke, Integration, and Regression Testing.</p>
                    </div>
                        ...
                        <div class="service-modal flex-center">
                            <div class="service-modal-body">
                                ...
                                <ul>
                                    ...
                                    <li><i class="fas fa-check-circle"></i> Create exceptional user experience</li>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide flex-center">
                                    ...
                                    <div class="client-details">
                                        <p>Hi, I'm Aria Collins andIam designer&developer who dream making the world better place by products.Iam also very active for international clients.
                                        </p>
                                        <h3>Aria Collins</h3>
                ...
                <div class="contact-left">
                    ...
                    <ul class="contact-list">
                        ...
                        <li class="contact-list">
                            ...
                            <span><a href="mailto:usamakhalid889@gmail.com">usamakhalid889@gmail.com</a></span>
                        </li>
                        <li class="contact-list">
